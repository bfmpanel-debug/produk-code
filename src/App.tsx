      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-20 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img 
              src="https://lh3.googleusercontent.com/d/1eBDBs2aDRdb73jnUR2tSMxuSof5vpeVR" 
              alt="Bungasari Logo" 
                  ...
                  <div className="p-8">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                      <div className="space-y-1">
                        <span className="inline-block px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-[10px] font-bold uppercase tracking-wider">
                          {item.JENIS}
                        </span>
                        <h3 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">{item["NAMA PRODUK"]}</h3>
                        <div className="flex flex-wrap gap-4 mt-2">
                          ...
                          <div className="flex items-center gap-1.5 text-slate-500 text-sm font-medium">
                            ...
                            Expired: {item["EXPIRED (BULAN)"]} Bln
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="bg-slate-950 rounded-2xl p-5 sm:p-6 shadow-inner relative group/code">
                        <div className="absolute top-4 right-4 group-hover:scale-110 transition-transform">
                          <Cpu className="w-6 h-6 text-blue-500 opacity-50" />
                        </div>
                        <h4 className="text-blue-400 text-[10px] font-black uppercase tracking-widest mb-4 flex items-center gap-2">
                          <div className="w-1.5 h-1.5 rounded-full bg-blue-500" />
                          Generated Production Code
                        </h4>
                        
                        <div className="space-y-3 font-mono">
                          <div className="bg-slate-900/50 p-3 sm:p-4 rounded-xl border border-slate-800 flex flex-col gap-0.5">
                             <span className="text-[9px] text-slate-600 font-bold uppercase">Line 1: Expired Date</span>
                             <span className="text-lg sm:text-2xl text-white font-black tracking-[0.2em]">{codes.line1}</span>
                          </div>
                          
                          <div className="bg-slate-900/50 p-3 sm:p-4 rounded-xl border border-slate-800 flex flex-col gap-0.5">
                             <span className="text-[9px] text-slate-600 font-bold uppercase">Line 2: Encoded Data</span>
                             <span className="text-base sm:text-xl text-white font-black tracking-wider break-all flex flex-wrap items-center">
                                {codes.line2.split(' ')[0]}
